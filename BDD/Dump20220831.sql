...
--
-- Host: 127.0.0.1    Database: sport360prueba
-- ------------------------------------------------------
...
CREATE TABLE `usuario_adm` (
  ...
  CONSTRAINT `usuario_adm_ibfk_1` FOREIGN KEY (`id_us_adm`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuario_invitado` (
  ...
  CONSTRAINT `usuario_invitado_ibfk_1` FOREIGN KEY (`id_us_invi`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuario_pago` (
  ...
  CONSTRAINT `usuario_pago_ibfk_1` FOREIGN KEY (`id_us_pago`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-08-31 20:49:25
